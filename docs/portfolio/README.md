...
| 02 | [WordPress + MySQL](02-wordpress-mysql/) | Pending | Live site, DB ready, network inspect |
| 03 | [Cloudflare Tunnel](03-cloudflare-tunnel/) | Pending | Tunnel healthy, public HTTPS padlock |
| 04 | [Caddy + DNS-01 TLS](04-caddy-dns01-tls/) | Pending | `casa.madearlabs.com` valid cert |
| 05 | [Tailscale Mesh](05-tailscale-mesh/) | Complete | 4-node status |
| 06 | [GPG Signing](06-gpg-signing/) | Pending | Pinentry prompt, signed log |
